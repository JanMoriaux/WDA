...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <?php } else if (isset($orderDetails) && count($orderDetails) > 0) { ?>
...
<!--                                </td>-->
                                ...
                                <td class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <form method="post" action="index.php?controller=Cart&action=deleteProduct">
                                        ...
                                        <button type="submit" class="text-danger cartIcon"
                                                title="Verwijderen uit mandje">
                                ...
                                <td class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                    <?php if ($orderDetail->getQuantity() < $product->getInStock()) { ?>
                                        <form method="post" action="index.php?controller=Cart&action=increaseUnits">
                                            <input type="hidden" name="id" value="<?php echo $product->getId(); ?>"/>
                                            <button type="submit" class="text-info cartIcon"
                                                    title="Hoeveelheid verhogen">
